# How to run wasm applications with wasmedge-extensions (Wasm-Bindgen and interpreter mode)
...
### Install WasmEdge Extensions addon for your application
...
```javascript
var wasmedge = require('wasmedge-extensions');
